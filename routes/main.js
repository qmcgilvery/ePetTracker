...
module.exports = function (app) {
  app.get("/", function (req, res) {
    let sqlquery =
      "SELECT * FROM walk_3 a LEFT JOIN pet_test1 b ON a.pet_id = b.pet_id WHERE a.walk_datetime >= NOW() ORDER BY walk_datetime ASC LIMIT 1; SELECT * FROM feed_3 a LEFT JOIN pet_test1 b ON a.pet_id = b.pet_id WHERE feed_datetime >= NOW() ORDER BY feed_datetime ASC LIMIT 1;";
    // execute sql query
...
// Andy Code==========================================================================
  ...
  app.get("/pet", function (req, res) {
    let sqlquery = "SELECT * FROM pet_test1; SELECT * FROM walk_3; SELECT * FROM feed_3";
    // execute sql query
    db.query(sqlquery, (err, result) => {
      if (err) {
        res.redirect("/");
  ...
  app.post("/save", function (req, res) {
    ...
    if (req.body.add_walk) {
      let sql =
        "INSERT INTO walk_3 (walk_name, walk_distance, walk_datetime, pet_id) VALUES (?, ?, ?, ?)";
      for (const key in req.body) {
        let new_records = req.body[key];
        // execute sql query
        db.query(sql, new_records, (err, result) => {
    ...
    if (req.body.add_feed) {
      console.log(req.body);
      let sql =
        "INSERT INTO feed_3 (feed_name, feed_type, feed_amount, feed_datetime, pet_id) VALUES (?, ?, ?, ?, ?)";
      for (const key in req.body) {
        let new_records = req.body[key];
        // execute sql query
        db.query(sql, new_records, (err, result) => {
  ...
  app.get("/delete_walk/:id", (req, res) => {
    ...
    let sql = `DELETE from walk_3 where walk_id = ${walkId}`;
  ...
  app.get("/delete_feed/:id", (req, res) => {
    ...
    let sql = `DELETE from feed_3 where feed_id = ${feedId}`;
    let query = db.query(sql, (err, result) => {
      if (err) throw err;
      res.redirect('/pet');
    });
  ...
  app.get("/todo", function (req, res) {
    ...
    let sqlquery =
      "SELECT * from walk_3 a LEFT JOIN pet_test1 b ON a.pet_id = b.pet_id WHERE a.walk_datetime >= CURDATE() AND a.walk_datetime < CURDATE() + INTERVAL 1 DAY ORDER BY a.walk_datetime; SELECT * from walk_3 a LEFT JOIN pet_test1 b ON a.pet_id = b.pet_id WHERE a.walk_datetime >= CURDATE() + INTERVAL 1 DAY AND a.walk_datetime < CURDATE() + INTERVAL 2 DAY ORDER BY a.walk_datetime; SELECT * from walk_3 a LEFT JOIN pet_test1 b ON a.pet_id = b.pet_id WHERE a.walk_datetime >= CURDATE() + INTERVAL 2 DAY AND a.walk_datetime < CURDATE() + INTERVAL 365 DAY ORDER BY a.walk_datetime; SELECT * from feed_3 a LEFT JOIN pet_test1 b ON a.pet_id = b.pet_id WHERE a.feed_datetime >= CURDATE() AND a.feed_datetime < CURDATE() + INTERVAL 1 DAY ORDER BY a.feed_datetime; SELECT * from feed_3 a LEFT JOIN pet_test1 b ON a.pet_id = b.pet_id WHERE a.feed_datetime >= CURDATE() + INTERVAL 1 DAY AND a.feed_datetime < CURDATE() + INTERVAL 2 DAY ORDER BY a.feed_datetime; SELECT * from feed_3 a LEFT JOIN pet_test1 b ON a.pet_id = b.pet_id WHERE a.feed_datetime >= CURDATE() + INTERVAL 2 DAY AND a.feed_datetime < CURDATE() + INTERVAL 365 DAY ORDER BY a.feed_datetime";
    // execute sql query
    db.query(sqlquery, (err, result) => {
      if (err) {
        res.redirect("/");
  ...
  app.post("/update_walk_complete", function (req, res) {
    ...
    let sqlquery = "UPDATE walk_3 SET walk_complete = (?) WHERE walk_id = (?);";
    // execute sql query
  ...
  app.post("/update_feed_complete", function (req, res) {
    // saving data in database
    let sqlquery = "UPDATE feed_3 SET feed_complete = (?) WHERE feed_id = (?);";
    // execute sql query
  ...
  app.get("/new_status", function (req, res) {
    ...
    let sqlquery =
      "SELECT * FROM pet_test1; SELECT * FROM walk_3; SELECT * FROM feed_3; SELECT * FROM walk_3 a left JOIN pet_test1 b ON a.pet_id = b.pet_id WHERE a.pet_id = 1; SELECT * FROM walk_3 a left JOIN pet_test1 b ON a.pet_id = b.pet_id WHERE a.pet_id = 2; SELECT * FROM walk_3 a left JOIN pet_test1 b ON a.pet_id = b.pet_id WHERE a.pet_id = 3; SELECT * FROM feed_3 a left JOIN pet_test1 b ON a.pet_id = b.pet_id WHERE a.pet_id = 1; SELECT * FROM feed_3 a left JOIN pet_test1 b ON a.pet_id = b.pet_id WHERE a.pet_id = 2; SELECT * FROM feed_3 a left JOIN pet_test1 b ON a.pet_id = b.pet_id WHERE a.pet_id = 3";
    // execute sql query
    db.query(sqlquery, (err, result) => {
      if (err) {
        res.redirect("/");
  ...
  app.post("/removewalk", function (req, res) {
    // saving data in database
    let sqlquery = "DELETE from walk_3 where walk_id = (?)";
    // execute sql query
  ...
  app.post(
   ...
   // render delete page 
    app.get("/delete", function (req, res) {
        ...
        let sqlquery = "SELECT * FROM pet_test1; SELECT * from walk_3 a LEFT JOIN pet_test1 b ON a.pet_id = b.pet_id ORDER BY walk_datetime; SELECT * from feed_3 a LEFT JOIN pet_test1 b ON a.pet_id = b.pet_id ORDER BY feed_datetime";
        // execute sql query
        db.query(sqlquery, (err, result) => {
            if (err) {
                res.redirect("/");
...
// handle form data from deleteForm submission
    app.post("/deletePet", function (req, res) {
        ...
        let sqlquery = "DELETE FROM `pet_test1` WHERE pet_id = (?)"
        // execute sql query
        for (const key in req.body) {
                let new_records = req.body[key];
    ...
    app.post("/deleteFeeding", function (req, res) {
        // query database to get all the devices
        let sqlquery = "DELETE FROM `feed_3` WHERE feed_id = (?);"
        // execute sql query
        for (const key in req.body) {
                let new_records = req.body[key];
                res.write(" This device has been deleted from the database, name: " + req.body[key]);
